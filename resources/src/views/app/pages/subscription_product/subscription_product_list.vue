  ...
  <div class="main-content">
    ...
    <b-card class="wrapper" v-if="!isLoading">
       ...
       <b-alert show variant="info">
        ⏱️ <strong>Автомотизация выставление счета</strong><br><br>
       После создания подписки система использует запланированные команды (задания cron) для автоматического выставления счетов.<br><br>

        <strong>1️⃣ Автомотическая генерация кода</strong><br>
        <code>php artisan subscriptions:generate-invoices</code><br>
        Это команда создаст новый счет для каждого активного кредита на основе ее платежного цикла (ежедневно, еженедельно, ежемесячно, ежегодно)<br><br>

        <strong>2️⃣ Отправка напоминаний и СМС</strong><br>
        <code>php artisan subscriptions:send-sms-reminders</code><br>
        Это команда отправляет клиентам напоминание о предстоящем дате погашение задолженности с помощью СМС<br><br>

        📌 <strong>Во время бета тестирование модуля запланирование задании Cron объязательно в панели управление сервером </strong>
      </b-alert>
