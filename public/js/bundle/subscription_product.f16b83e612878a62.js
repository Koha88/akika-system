...
var render = function render() {
  ...
  }, [_vm._v("\n      ⏱️ "), _c("strong", [_vm._v("Автомотизация выставление счета")]), _c("br"), _c("br"), _vm._v("\n     После создания подписки система использует запланированные команды (задания cron) для автоматического выставления счетов."), _c("br"), _c("br"), _vm._v(" "), _c("strong", [_vm._v("1️⃣ Автомотическая генерация кода")]), _c("br"), _vm._v(" "), _c("code", [_vm._v("php artisan subscriptions:generate-invoices")]), _c("br"), _vm._v("\n      Это команда создаст новый счет для каждого активного кредита на основе ее платежного цикла (ежедневно, еженедельно, ежемесячно, ежегодно)"), _c("br"), _c("br"), _vm._v(" "), _c("strong", [_vm._v("2️⃣ Отправка напоминаний и СМС")]), _c("br"), _vm._v(" "), _c("code", [_vm._v("php artisan subscriptions:send-sms-reminders")]), _c("br"), _vm._v("\n      Это команда отправляет клиентам напоминание о предстоящем дате погашение задолженности с помощью СМС"), _c("br"), _c("br"), _vm._v("\n\n      📌 "), _c("strong", [_vm._v("Во время бета тестирование модуля запланирование задании Cron объязательно в панели управление сервером ")])]), _vm._v(" "), _c("vue-good-table", {
    attrs: {
      mode: "remote",
      columns: _vm.columns,
