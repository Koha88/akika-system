...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    ...
    return {
      ...
      product: (_product = {
        ...
        has_stone: false,
        has_diamond: false
      }, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_product, "gold_purity", []), "custom_gold_purity", ''), "cost", ""), "price", ""), "brand_id", ""), "category_id", ""), "TaxNet", "0"), "tax_method", "1"), "unit_id", ""), "unit_sale_id", ""), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_product, "unit_purchase_id", ""), "stock_alert", "0"), "image", ""), "note", ""), "is_variant", false), "is_imei", false), "not_selling", false), "warranty_period", null), "warranty_unit", 'months'), "warranty_terms", ''), _defineProperty(_defineProperty(_defineProperty(_product, "has_guarantee", false), "guarantee_period", null), "guarantee_unit", 'months')),
      code_exist: ""
    };
  },
  watch: {
    ...
    'product.category_id': function () {
      var _productCategory_id = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(newCategoryId) {
        var code;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              ...
              _context.n = 1;
              return this.generateProductCode(newCategoryId);
            case 1:
              code = _context.v;
              if (code) {
            ...
            case 2:
              stoneOptions: [{
                ...
                label: 'Amethyst (Аметист)',
                value: 'amethyst'
              }, {
                label: 'Diamond (Бриллиант)',
                value: 'diamond'
              }, {
                label: 'Other',
                value: 'other'
      ...
      function productCategory_id(_x) {
        return _productCategory_id.apply(this, arguments);
      }
  ...
  methods: {
    ...
    calculatePrice: function calculatePrice() {
      var weight = parseFloat(this.product.weight) || 0;
      var gold = parseFloat(this.product.gold_price_per_gram) || 0;
      var margin = parseFloat(this.product.margin_percent) || 0;
      var cost = weight * gold;
      var price = cost + cost * margin / 100;
      this.product.cost = cost;
      this.product.price = price;
    },
    getWeightFromScale: function getWeightFromScale() {
      var _this = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        var response, weight, _t;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.n) {
            case 0:
              _context2.p = 0;
              _context2.n = 1;
              return axios.get('http://localhost:3000/getWeight');
            case 1:
              response = _context2.v;
              weight = parseFloat(response.data.weight);
              if (!isNaN(weight)) {
                _this.product.weight = weight;
                _this.calculatePrice(); // если есть пересчёт
              } else {
                _this.$bvToast.toast('Ошибка: неверный ответ от весов', {
                  variant: 'danger'
                });
              }
              _context2.n = 3;
            ...
            case 2:
              _context2.p = 2;
              _t = _context2.v;
              _this.$bvToast.toast('Не удалось получить вес с весов', {
                variant: 'danger'
              });
              console.error(_t);
            case 3:
    ...
    generateProductCode: function generateProductCode(category_id) {
      return axios.get("/generate_product_code/".concat(category_id)).then(function (response) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        ...
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.n) {
            ...
            case 1:
              _yield$_this4$$refs$I = _context3.v;
              valid = _yield$_this4$$refs$I.valid;
              if (valid) {
                _this4.product.image = e.target.files[0];
              } else {
                _this4.product.image = "";
              }
            case 2:
    ...
    Submit_Product: function Submit_Product() {
      ...
      this.$refs.Create_Product.validate().then(function (success) {
        if (!success) {
          ...
          if (_this5.product.type == 'is_variant' && _this5.variants.length <= 0) {
            _this5.makeToast("danger", "The variants array is required.", _this5.$t("Failed"));
          } else {
            _this5.Create_Product();
          }
        }
      });
    },
    ...
    GetElements: function GetElements() {
      ...
      axios.get("products/create").then(function (response) {
        ...
        _this6.units = response.data.units;
        ...
        response.data.warehouses.forEach(function (wh) {
          ...
          _this6.$set(_this6.product.warehouses, wh.id, {
            qte: wh.qte
          });
        });
        ...
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.n) {
            case 0:
              ...
              _this8.calculatePrice(); // чтобы product.cost_price и product.final_price были обновлены
              _context4.n = 1;
              return _this8.generateProductCode(_this8.product.category_id);
            case 1:
              newCode = _context4.v;
              if (newCode) {
                _this8.product.code = newCode;
              }
              ...
              Object.entries(self.product).forEach(function (_ref6) {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref2) {
        ...
        return _c("b-form-group", {
          ...
          model: {
            value: _vm.product.gold_purity,
            callback: function callback($$v) {
              _vm.$set(_vm.product, "gold_purity", $$v);
            },
            expression: "product.gold_purity"
          }
        }, [_c("b-form-radio", {
          attrs: {
            value: "585"
          }
        }, [_vm._v("585")]), _vm._v(" "), _c("b-form-radio", {
          attrs: {
            value: "750"
          }
        }, [_vm._v("750")]), _vm._v(" "), _c("b-form-radio", {
          attrs: {
            value: "other"
          }
        }, [_vm._v("Другое")])], 1), _vm._v(" "), _vm.product.gold_purity === "other" ? _c("b-form-input", {
          staticClass: "mt-2",
          attrs: {
            placeholder: "Укажите пробу, например: 916"
          },
          model: {
            value: _vm.product.custom_gold_purity,
            callback: function callback($$v) {
              _vm.$set(_vm.product, "custom_gold_purity", $$v);
            },
            expression: "product.custom_gold_purity"
          }
        }) : _vm._e(), _vm._v(" "), _c("b-form-invalid-feedback", [_vm._v(_vm._s(errors[0]))])], 1);
      }
    }], null, false, 633334623)
  })], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-2",
    attrs: {
      md: "6"
    ...
    model: {
      value: _vm.product.has_diamond,
      callback: function callback($$v) {
        _vm.$set(_vm.product, "has_diamond", $$v);
      },
      expression: "product.has_diamond"
    }
    ...
    model: {
      value: _vm.product.has_stone,
      callback: function callback($$v) {
        _vm.$set(_vm.product, "has_stone", $$v);
      },
      expression: "product.has_stone"
    }
  }, [_vm._v("\n      🪨 Есть камни\n    ")]), _vm._v(" "), _vm.product.has_diamond ? _c("validation-provider", {
    attrs: {
      name: "Карат бриллианта"
    },
    scopedSlots: _vm._u([{
      key: "default",
      fn: function fn(_ref4) {
        ...
        return _c("b-form-group", {
          attrs: {
            label: "Карат бриллианта"
          }
        }, [_c("input", {
          directives: [{
            name: "model",
            rawName: "v-model",
            value: _vm.product.diamond_carat,
            expression: "product.diamond_carat"
          }],
          staticClass: "form-control",
          "class": {
            "is-invalid": !!errors.length
          ...
          on: {
            input: [function ($event) {
              ...
              _vm.$set(_vm.product, "diamond_carat", $event.target.value);
            }, validate]
          }
        }), _vm._v(" "), _c("b-form-invalid-feedback", [_vm._v(_vm._s(errors[0]))])], 1);
      }
    }], null, false, 1929660264)
  }) : _vm._e(), _vm._v(" "), _vm.product.has_stone ? _c("validation-provider", {
    attrs: {
      name: "Тип камня"
    },
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref5) {
        ...
        return _c("b-form-group", {
          ...
          model: {
            value: _vm.product.stone_type,
            callback: function callback($$v) {
              _vm.$set(_vm.product, "stone_type", $$v);
            },
            expression: "product.stone_type"
          }
        }, [_c("b-form-checkbox", {
          attrs: {
            value: "d1"
          }
        }, [_vm._v("💎 D1")]), _vm._v(" "), _c("b-form-checkbox", {
          attrs: {
            value: "d2"
          }
        }, [_vm._v("💎 D2")]), _vm._v(" "), _c("b-form-checkbox", {
          attrs: {
            value: "d3"
          }
        }, [_vm._v("💎 D3")]), _vm._v(" "), _c("b-form-checkbox", {
          attrs: {
            value: "other"
          }
        }, [_vm._v("✏️ Другое")])], 1), _vm._v(" "), _c("b-form-invalid-feedback", [_vm._v(_vm._s(errors[0]))]), _vm._v(" "), _vm.product.stone_type && _vm.product.stone_type.includes("other") ? _c("b-form-input", {
          staticClass: "mt-2",
          attrs: {
            placeholder: "Укажите тип камня"
          },
          model: {
            value: _vm.product.custom_stone_type,
            callback: function callback($$v) {
              _vm.$set(_vm.product, "custom_stone_type", $$v);
            },
            expression: "product.custom_stone_type"
          }
        }) : _vm._e()], 1);
      }
    }], null, false, 3454204109)
      ...
      fn: function fn(_ref7) {
        ...
        return [_c("b-form-group", {
          ...
          model: {
            ...
            callback: function callback($$v) {
              _vm.$set(_vm.product, "weight", _vm._n($$v));
            },
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref8) {
        ...
        return [_c("b-form-group", {
          ...
          model: {
            value: _vm.product.gold_price_per_gram,
            callback: function callback($$v) {
              _vm.$set(_vm.product, "gold_price_per_gram", _vm._n($$v));
            },
            expression: "product.gold_price_per_gram"
          }
        }), _vm._v(" "), _c("b-form-invalid-feedback", [_vm._v(_vm._s(errors[0]))])], 1)];
      }
    }], null, false, 3844893976)
  })], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-2",
    attrs: {
      lg: "6",
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref9) {
        ...
        return [_c("b-form-group", {
          ...
          model: {
            value: _vm.product.margin_percent,
            callback: function callback($$v) {
              _vm.$set(_vm.product, "margin_percent", _vm._n($$v));
            },
            expression: "product.margin_percent"
          }
        }), _vm._v(" "), _c("b-form-invalid-feedback", [_vm._v(_vm._s(errors[0]))])], 1)];
      }
    }], null, false, 2259814962)
  })], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-2",
    attrs: {
      lg: "6",
    ...
    attrs: {
      value: _vm.formatNumber(_vm.product.cost, 2),
      readonly: ""
    }
  })], 1)], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-2",
    ...
    attrs: {
      value: _vm.formatNumber(_vm.product.price, 2),
      readonly: ""
    }
  })], 1)], 1), _vm._v(" "), _vm._l(_vm.warehouses, function (wh) {
    return _c("b-col", {
      key: wh.id,
      staticClass: "mb-2",
      attrs: {
  ...
  })])], 1)], 2)], 1), _vm._v(" "), _vm.product.type == "is_combo" ? _c("b-card", {
    staticClass: "mt-3"
  }, [_c("b-row", [_c("div", {
    ...
    staticClass: "mt-3"
  }, [_c("b-row", [_vm.product.type != "is_service" ? _c("b-col", {
    staticClass: "mb-2",
    attrs: {
      md: "6"
    }
  ...
  })], 1), _vm._v(" "), _vm.product.type == "is_variant" ? _c("div", {
  ...
  })], 2)])])]) : _vm._e()], 1)], 1), _vm._v(" "), _vm.product.type != "is_combo" ? _c("b-card", {
    staticClass: "mt-3"
  }, [_c("b-row")], 1) : _vm._e()], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mt-3",
    attrs: {
      md: "12"
    }
